...
export const ETHICS_GUIDE_TITLE = "윤리 핵심가이드";

export const ETHICS_GUIDE_ACCEPT_LABEL =
  "나는 윤리 핵심가이드를 빠짐없이 읽고 이를 실천하겠습니다.";

/** sessionStorage — 탭/접속 단위 동의 여부 (매 접속·새 게임 시 초기화) */
export const ETHICS_GUIDE_STORAGE_KEY = "ethicsGuideAccepted";
...
export const ETHICS_GUIDE_ITEMS: EthicsGuideItem[] = [
  {
    id: 1,
    values: [CORE_VALUES.initiative, CORE_VALUES.purposiveness],
    guideLabel: "가이드 1: 활용 목적",
    headline: "생성형 AI를 쓰기 전, '왜' 쓰는지 말할 수 있어야 해요.",
    description:
  ...
  {
    id: 2,
    values: [CORE_VALUES.initiative],
    guideLabel: "가이드 2: 주도적 학습",
    headline: "생성형 AI에게 물어보기 전, 내 생각을 먼저 말해요.",
    description:
  ...
  },
  {
    id: 3,
    values: [CORE_VALUES.initiative],
    guideLabel: "가이드 3: 비판적 검증",
    headline: "생성형 AI가 틀릴 수 있다는 점을 알아요.",
    description:
  ...
  },
  {
    id: 4,
    values: [CORE_VALUES.initiative, CORE_VALUES.purposiveness],
    guideLabel: "가이드 4: 사고의 확장",
    headline: "생성형 AI와 함께 상상하며 내 생각을 더 크게 키워요.",
    description:
      "생성형 AI를 내 생각의 범위를 넓혀주는 도구로 사용해보세요. 생성형 AI의 결과물을 그대로 사용하지 않고, 나의 경험과 생각을 더하여 나만의 색깔을 담은 최종 결과물을 만들어요.",
  },
  {
    id: 5,
    values: [CORE_VALUES.safety],
    guideLabel: "가이드 5: 안전과 관계",
    headline: "나의 정보와 비밀을 말하지 않아요.",
    description:
  ...
  {
    id: 6,
    values: [CORE_VALUES.transparency],
    guideLabel: "가이드 6: 투명성·윤리",
    headline:
